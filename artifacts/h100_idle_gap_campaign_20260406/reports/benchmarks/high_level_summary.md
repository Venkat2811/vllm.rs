...
|----------------------------------------------------------|---------|
| requested_relaxed_observed -> requested_relaxed_observed |       4 |
...
| Qwen/Qwen3-4B   | serving_qos        | cold_turn_idle_gap  | tp2                |                          -0.7777 |                       1.543 |                     1.531 | requested_relaxed_observed          | requested_relaxed_observed        |
...
| Qwen/Qwen3-4B   | serving_qos        | cold_turn_idle_gap  | tp2                |                  2.2414 |                 137.19  |               140.265 | requested_relaxed_observed          | requested_relaxed_observed        |
...
| Qwen/Qwen3-4B   | serving_qos        | cold_turn_idle_gap  | tp2                |                    -2.0235 |                    5422.14 |                  5312.42 |                                       |                                     |
| Qwen/Qwen3-4B   | serving_qos        | warm_steady_state   | tp2                |                   -15.6678 |                    5915.91 |                  4989.02 |                                       |                                     |
...
|---------------|--------------------|---------------------|--------------------|--------------------------------------|--------------------------------------|------------------------------------|-------------------------------------|-----------------------------------|
| Qwen/Qwen3-4B | serving_qos        | warm_steady_state   | tp2                |                              -1.087  |                               46     |                             45.5   | requested_relaxed_observed          | requested_relaxed_observed        |
| Qwen/Qwen3-4B | serving_qos        | cold_turn_idle_gap  | tp2                |                               2.4279 |                               58.857 |                             60.286 | requested_relaxed_observed          | requested_relaxed_observed        |
...
| Qwen/Qwen3-4B   | serving_qos        | warm_steady_state   | tp2                |                          -1.0119 |                       3.36  |                     3.326 | requested_relaxed_observed          | requested_relaxed_observed        |
| Qwen/Qwen3-4B   | serving_qos        | cold_turn_idle_gap  | tp2                |                          -0.7777 |                       1.543 |                     1.531 | requested_relaxed_observed          | requested_relaxed_observed        |
| Qwen/Qwen3-0.6B | serving_qos        | cold_turn_idle_gap  | tp2                |                          -0.2233 |                       1.791 |                     1.787 | requested_relaxed_observed          | requested_relaxed_observed        |
| Qwen/Qwen3-4B   | pd_qos             | cold_turn_idle_gap  | pd_tp1             |                          -0.0859 |                       1.164 |                     1.163 |                                     |                                   |
