...
|--------------------|------------------|-----------------------------------------|------------------|----------------|-----------------|-------------------|-----------------|
| runner             | myelon           | requests_per_sec                        |            1.564 |          1.576 |          0.7673 | completed         | completed       |
| runner             | myelon           | runtime_sec                             |           20.454 |         20.306 |         -0.7236 | completed         | completed       |
| runner             | myelon           | ttft_ms_mean                            |          547.95  |        544.52  |         -0.626  | completed         | completed       |
| runner             | myelon           | tpot_ms_mean                            |           12.07  |         11.86  |         -1.7399 | completed         | completed       |
| runner             | myelon           | latency_ms_mean                         |          632.46  |        627.52  |         -0.7811 | completed         | completed       |
...
| runner             | myelon           | observed_gpu_kv_usage_percent_max       |            1.1   |          1.1   |          0      | completed         | completed       |
...
| runner             | myelon           | observed_prefill_seconds_total          |           17.29  |         17.28  |         -0.0578 | completed         | completed       |
| runner             | myelon           | observed_prefill_tps_mean               |         2304.58  |       2313.76  |          0.3983 | completed         | completed       |
| runner             | myelon           | observed_prompt_metric_event_count      |           32     |         32     |          0      | completed         | completed       |
| runner             | myelon           | observed_prompt_seconds_total           |           17.29  |         17.28  |         -0.0578 | completed         | completed       |
| runner             | myelon           | observed_prompt_tps_mean                |         2302.42  |       2311.59  |          0.3981 | completed         | completed       |
| runner             | myelon           | observed_decode_metric_event_count      |           32     |         32     |          0      | completed         | completed       |
| runner             | myelon           | observed_decode_seconds_total           |            2.67  |          2.57  |         -3.7453 | completed         | completed       |
| runner             | myelon           | observed_decode_tps_mean                |           94.589 |         96.476 |          1.9949 | completed         | completed       |
